...
const HomeBestInternational = () => {
  return (
    <div className='p-4 w-full border-b border-gray-300'>
      ...
      <a href={replaceAmazon("https://www.amazon.com/InkjetsClub-910XL-Pack-High-Yield/dp/B09Y97BRC8/ref=sr_1_1_sspa?keywords=HP+910XL+Black+High-yield+Ink+Cartridge+Rp+613.350%2C00&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1", "/item")} className='w-full flex gap-4 mb-4'>
      ...
      <a href={replaceAmazon("https://www.amazon.com/AmazonBasics-Multipurpose-Copy-Printer-Paper/dp/B01FV0F75G/ref=sr_1_1_ffob_sspa?keywords=Basics+Multipurpose+Copy+Printer+Paper&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1", "/item")} className='w-full flex gap-4 mb-8'>
      ...
      <a href={replaceAmazon("https://www.amazon.com/206X-206A-Toner-Cartridges-Replacement/dp/B0B5TMY3ZC/ref=sr_1_1_sspa?keywords=Original+HP+206X+Black+High-yield+Toner+Cartridge&sr=8-1-spons&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&psc=1&smid=A34V69SFKQ28Z0", "/item")} className='w-full flex gap-4 mb-4'>
